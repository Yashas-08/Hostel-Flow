...
export default function AdminProfilePage() {
  ...
  async function load() {
    ...
    setError(null);
    try {
      setProfile(await api.get<AdminProfile>('/auth/me'));
    } catch (e) {
  ...
  return (
    <>
      <AdminHeader name={profile?.fullName ?? ''} title="Settings" />
      <AdminScreen>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3.5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-[var(--color-ink-muted)] truncate">Admin</p>
                </div>
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <NavRow
                  ...
                  onClick={() => navigate('/admin/profile/notifications')}
                />
              </div>
